...
from openrlhf.extensions.moe.utils.moe_layers import LinearGLUMoELayer, MoEMlpOutput
from openrlhf.extensions.moe.utils.norm import WeightNorm
...
class LlamaMoEDecoderLayer(LlamaDecoderLayer, GradientCheckpointingLayer):
...
# @auto_docstring
class LlamaMoEForCausalLM(LlamaMoEPreTrainedModel, LlamaForCausalLM, GenerationMixin):
